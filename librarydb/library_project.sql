...
CREATE TABLE rent_info(
    ...
    reqired_return_date 	TIMESTAMP  	 NOT NULL,
    return_date				TIMESTAMP    DEFAULT NULL, 
    CONSTRAINT rent_info_PK PRIMARY KEY (id),
    CONSTRAINT rent_info_book_FK FOREIGN KEY (book_id) REFERENCES book(id),
...
INSERT INTO rent_info(book_id, user_id, rent_status, rent_date, reqired_return_date, return_date)
	VALUES ('1', '2', 'ACTIVE', '2021-03-21 15:00:00', '2021-04-21 15:00:00', '2021-04-21 15:00:00'),
		   ('2', '2', 'ACTIVE', '2021-04-21 15:00:00', '2021-06-21 15:00:00', '2021-07-21 15:00:00'),
		   ('2', '3', 'ACTIVE', '2021-05-21 15:00:00', '2021-06-21 15:00:00', NULL),
		   ('2', '3', 'ACTIVE', '2021-06-12 15:00:00', '2021-07-12 15:00:00', NULL),
		   ('2', '1', 'ACTIVE', '2021-06-21 15:00:00', '2021-07-21 15:00:00', NULL),
		   ('1', '1', 'REQUESTED', '2021-07-21 15:00:00', '2021-08-21 15:00:00', NULL),
		   ('1', '1', 'REQUESTED', '2021-07-22 15:00:00', '2021-08-22 15:00:00', NULL),
	       ('3', '1', 'REQUESTED', '2021-02-21 15:00:00', '2021-03-21 15:00:00', NULL),
	       ('3', '1', 'EXPIRED', '2021-02-21 15:00:00', '2021-06-21 15:00:00', NULL);
