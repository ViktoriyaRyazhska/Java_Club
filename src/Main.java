...
public class Main {
    public static void main(String[] args) {
        ...
        switch (taskNumber) {
            case 1:  Task1.execute(sc);  break;
            case 2:  task2.execute(sc);  break;     case 5:  Task5.execute(sc);  break;
            case 3:  Task3.execute(sc);  break;
            case 4: Task4.execute(sc);   break;
            case 6:  task6.execute(sc);  break;
            case 7:  Clock.execute(sc);  break;
            case 8:  task8.execute(sc);  break;
            case 9:  task9.execute(sc);  break;
            case 10: task10.execute(sc); break;     case 12: task12.execute(sc); break;
            case 13: Dinglemouse.execute(sc); break;
            case 14: task14.execute(sc); break;
            case 16: task16.execute(sc); break;
            case 17: Block.execute(sc);  break;
            case 18: task18.execute(sc); break;
            case 22: task22.execute(sc); break;
            case 25: OppositesAttract.execute(sc); break;
            case 29: Kata.execute(sc);   break;
            case 26: task26.execute(sc); break;
            case 30: task30.execute(sc); break;
            case 33: task33.execute(sc); break;
            ...
            case 50: task50.execute(sc); break;
            case 52: task52.execute(sc); break;
            case 54: task54.execute(sc); break;
            case 56: task56.execute(sc); break;
            case 58: task58.execute(sc); break;
            case 60: Task60.execute(sc); break;
            case 62: task62.execute(sc); break;
            case 64: task64.execute(sc); break;
            case 66: task66.execute(sc); break;
            case 68: Task68.execute(sc); break;
            case 70: task70.execute(sc); break;
